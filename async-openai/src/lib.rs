...
//! let http_client = reqwest::ClientBuilder::new().user_agent("async-openai2").build().unwrap();
...
//! let client = Client::with_config(config);
//!
//! // Note that Azure OpenAI service does not support all APIs and `async-openai2`
